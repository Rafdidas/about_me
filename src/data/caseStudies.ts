...
export const caseStudies = [
  {
    ...
    sections: [
      ...
      {
        label: "Role",
        body: "버튼, 액션바, 테이블, 모달, 오토컴플리트 등 반복 UI 요소를 정리하고, 색상 변수·타이포그래피·모바일 스타일을 디자인 시스템 기준에 맞춰 적용하는 과정에 참여했습니다."
      },
      {
        label: "Action",
        body: "화면에 흩어져 있던 색상·타이포그래피 기준을 정리하고, 반복 UI 요소를 공통 컴포넌트 관점에서 개선했습니다. 또한 여러 업무 화면에서 같은 기준으로 재사용할 수 있도록 적용 범위와 상태 표현을 맞췄습니다."
      },
      {
        label: "Result",
        body: "버튼, 액션바, 테이블, 모달, 오토컴플리트 등 5종 이상의 반복 UI 유형을 공통 기준으로 정리해 화면별 UI 편차를 줄이고, 운영 유지보수 과정에서 같은 기준으로 화면을 수정할 수 있는 기반을 마련했습니다."
      },
      {
