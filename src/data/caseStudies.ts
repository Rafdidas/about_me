export const caseStudies = [
  {
    ...
    sections: [
      ...
      {
        label: "Role",
        body: "버튼, 액션바, 테이블, 모달, 오토컴플리트 등 반복 UI 요소를 정리하고 색상 변수, 타이포그래피, 모바일 스타일 적용 과정에 참여했습니다."
      },
      {
        label: "Action",
        body: "흩어져 있던 색상·타이포그래피 기준을 정리하고, 반복 UI 요소를 공통 컴포넌트 관점에서 개선해 여러 업무 화면에서 재사용 가능한 기준으로 맞췄습니다."
      },
      {
        label: "Result",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        label: "Problem",
        body: "데이터 중심 업무 화면은 단순 배치보다 스크롤 영역, 사이드 영역, 페이지네이션, 상태 표시 기준을 함께 맞춰야 했습니다."
      },
      {
        label: "Role",
        body: "Next.js, React 기반 프로젝트에서 주요 시스템 UI 구조와 PC·모바일 화면 퍼블리싱을 담당했습니다."
      },
      {
        label: "Action",
        body: "단설관리, 관제정보, 대시보드, 현장관리, 비용관리, 업체선정 등 데이터 중심 업무 화면을 구현하고, 화면별 재사용성을 고려해 공통 UI 구조를 정리했습니다."
      },
      {
        label: "Result",
